...
pennylane/beta/devices/__init__.py
pennylane/beta/devices/default_tensor.py
pennylane/beta/devices/default_tensor_tf.py
pennylane/beta/devices/numpy_ops.py
...
pennylane/devices/tests/__init__.py
...
pennylane/devices/tests/test_wires.py
pennylane/grouping/__init__.py
pennylane/grouping/graph_colouring.py
pennylane/grouping/group_observables.py
pennylane/grouping/optimize_measurements.py
pennylane/grouping/transformations.py
...
pennylane/math/autograd_box.py
pennylane/math/fn.py
pennylane/math/jax_box.py
pennylane/math/numpy_box.py
pennylane/math/tensorbox.py
pennylane/math/tf_box.py
pennylane/math/torch_box.py
pennylane/numpy/__init__.py
pennylane/numpy/fft.py
pennylane/numpy/linalg.py
pennylane/numpy/random.py
pennylane/numpy/tensor.py
pennylane/numpy/wrapper.py
...
pennylane/qaoa/mixers.py
pennylane/qnn/__init__.py
pennylane/qnn/cost.py
...
pennylane/qnodes/rev.py
pennylane/tape/__init__.py
pennylane/tape/circuit_graph.py
pennylane/tape/measure.py
pennylane/tape/operation.py
pennylane/tape/operation_recorder.py
pennylane/tape/qnode.py
pennylane/tape/queuing.py
pennylane/tape/interfaces/__init__.py
pennylane/tape/interfaces/autograd.py
pennylane/tape/interfaces/tf.py
pennylane/tape/interfaces/torch.py
pennylane/tape/tapes/__init__.py
...
pennylane/tape/tapes/tape.py
pennylane/tape/transforms/__init__.py
pennylane/tape/transforms/metric_tensor.py
pennylane/templates/__init__.py
pennylane/templates/broadcast.py
pennylane/templates/decorator.py
pennylane/templates/layer.py
...
pennylane/templates/subroutines/double_excitation_unitary.py
pennylane/templates/subroutines/interferometer.py
pennylane/templates/subroutines/permute.py
pennylane/templates/subroutines/single_excitation_unitary.py
...
tests/test_measurement_transformations.py
tests/test_numpy_wrapper.py
...
tests/test_qubit_device_adjoint_jacobian.py
